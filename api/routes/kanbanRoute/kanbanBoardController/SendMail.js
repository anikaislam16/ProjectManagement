...
const sendJoingProjectEmail = (toEmail, username, projectId, projectName, role) => {
    const mailOptions = {
      ...
      <a href="${process.env.front_end}/project/kanban/${projectId}" style="display: inline-block; padding: 10px 20px; background-color: #3498db; color: #ffffff; text-decoration: none; border-radius: 5px;">Check Board</a>`,
    };
