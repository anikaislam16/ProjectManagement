  ...
  useEffect(() => {
    if (
      !(
        loc.pathname === "/login" ||
        loc.pathname === "/signup" ||
        loc.pathname === "/signup/password" ||
        loc.pathname === "/signup/otp" ||
        loc.pathname === "/forgot-password" ||
        loc.pathname === "/forgot-password/otp" ||
        loc.pathname === "/Updatepass"
      )
    ) {
      console.log("k");
        ...
        if (userData.hasOwnProperty("message")) {
          ...
          const fetchProjectData = async () => {
            try {
              ...
              console.error(
                "Error updating projects by member:",
                error.message
              );
              throw error;
            }
      ...
      <nav className="navbar">
        <ul className="navbar-list">
          <li className="navbar-item inv">
            <Button className="btn btn-light" onClick={handleHomeBtn}>
              {" "}
              Home{" "}
            </Button>
          </li>
