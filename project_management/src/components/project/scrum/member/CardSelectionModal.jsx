...
const CardSelectionModal = ({
  ...
  const removeMember = async (card) => {
    const apiUrl = `${process.env.REACT_APP_HOST}/projects/scrum/${projectId}/${card.boardId}/${card.id}/members/${member_id}`;
    try {
    ...
    try {
      for (const card of selectedCards) {
        ...
        if (!checkMemberIdInCardMember) {
          ...
          const apiUrl = `${process.env.REACT_APP_HOST}/projects/scrum/${projectId}/${card.boardId}/${card.id}`;
          try {
            const response = await fetch(apiUrl, {
              method: "PUT",
              headers: {
        ...
        const response = await fetch(
          `${process.env.REACT_APP_HOST}/test/scrum/${projectId}/manytest/${card.boardId}/${card.id}`,
          {
            method: "PUT",
            headers: {
              "Content-Type": "application/json",
