...
export default function MyProject() {
    ...
    const handleClick = (creatorName, creatorId) => {
        navigate(`/member/${creatorName}${creatorId}`, { state: { userId: creatorId } });
            ...
            <div className="row">
                {projects.map(project => (
                    <div key={project._id} className="col-md-4 mb-4">
                        <Card>
                            <Card.Body>
                                <Card.Title data-toggle="tooltip" data-placement="top" title={project.projectName}>{project.projectName}</Card.Title>
                                <br />
                                <div className="row">
                                    <div className="col-5">
                                        <Card.Text><b>Project Type:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                        <Card.Text>{project.projectType}</Card.Text>
                                    </div>
                                    <div className="col-5">
                                        <Card.Text><b>Creation Date:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                        <Card.Text>{(new Date(project.creationTime)).toLocaleDateString()}</Card.Text>
                                    </div>
                                    <div className="col-5">
                                        <Card.Text><b>Creator:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                        <Card.Text
                                            style={{ cursor: 'pointer', color: 'blue' }}
                                            onClick={() => handleClick(project.creatorName, project.creatorId)}
                                        >
                                            {project.creatorName}
                                        </Card.Text>
                                    </div>
                                    <div className="col-5">
                                        <Card.Text><b>No. of Members:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                        <Card.Text>{project.members}</Card.Text>
                                    </div>
                                    <div className="col-5">
                                        <Card.Text><b>Week Days:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                        <Card.Text>{project.weekDays.join(', ')}</Card.Text>
                                    </div>
                                    <div className="col-5">
                                        <Card.Text><b>Your Role:</b></Card.Text>
                                    </div>
                                    <div className='col-7'>
                                ...
                                <br />
                                <Button variant="primary" onClick={() => handleProjectButton(project.projectType, project._id)}>Go To Boards</Button>
                            </Card.Body>
                        </Card>
                    </div>
                ))}
