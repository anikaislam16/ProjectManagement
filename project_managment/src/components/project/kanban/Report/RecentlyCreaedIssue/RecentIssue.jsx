  ...
  return (
    ...
    >
      <div className="center-content">
        <h2 style={{ textAlign: "center" }}>Recently Created Issue Chart</h2>
        <form>
          <div className="mb-3">
          ...
          <div className="mb-3">
            <label htmlFor="daysPreviously" className="form-label">
              Days Previously:
            </label>
            <input
              type="number"
              ...
              onChange={(e) => setDaysPreviously(e.target.value)}
              onKeyDown={(e) => {
                if (e.key === "Enter") {
                  e.preventDefault();
                }
          ...
          {isSubmitted && (
            <Barchart fromDate={fromDate} toDate={toDate} period={period} />
          )}
        </form>
      </div>
    </div>
