...
const ControlChart = () => {
  ...
  const handleFormSubmit = async (values) => {
    ...
    const a = boards.filter((board) =>
      values.selectedColumns.includes(board._id)
    );
    console.log(boards);
    console.log(a);
  ...
  return (
    ...
    >
      <div className="center-content">
        <h2 style={{ textAlign: "center" }}>Control Chart</h2>
            ...
            {({ values, setFieldValue }) => (
              <Form className="frm">
                <div className="form-side time">
                  <div className="form-group">
                    ...
                    <Field
                      ...
                      onClick={(e) => {
                        setFieldValue(
                          "fromDate",
                          getDefaultFromDate(e.target.value)
                        );
                        setFieldValue(
                          "toDate",
                  ...
                  <div className="form-group">
                    <label style={{ marginRight: "45px" }}>From:</label>
                    <Field
                      type="date"
                      name="fromDate"
                      onChange={(e) => {
                  ...
                  <div className="form-group">
                    <label style={{ marginRight: "67px" }}> To:</label>
                    <Field
                      type="date"
                      s
                      name="toDate"
                        ...
                        {boards.map((board) => (
                          <div key={board._id} className="dropdown-item">
                            <Field
                              ...
                              value={board._id}
                              checked={values.selectedColumns.includes(
                                board._id
                              )}
                            />
                            <label htmlFor={`boardCheckbox_${board._id}`}>
                              {board.name}
                            </label>
                          </div>
                        ))}
