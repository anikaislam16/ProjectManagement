...
const KanbanEditableHeader = ({ value, id, initialValue, onSave, onClose }) => {
    ...
    return (
        <div>
            {isEditing ? (
                ...
                <h6
                    className={`flex-grow-1 ${value && value.completed === true ? "strike-through" : ""
                        }`}
...
export default KanbanEditableHeader;
